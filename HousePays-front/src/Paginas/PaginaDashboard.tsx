        ...
        <div className="space-y-8 animate-fade-in">
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card
                    ...
                    icone={<ArrowUpCircle className="w-12 h-12 text-emerald-500/20" />}
                />
                <Card
                    titulo="Despesas Totais"
                    valor={totalDespesasGeral}
                    icone={<ArrowDownCircle className="w-12 h-12 text-rose-500/20" />}
                    tipo="erro"
                />
                <Card
                    titulo="Saldo Líquido Geral"
                    valor={saldoLiquidoGeral}
                    icone={<Wallet className="w-12 h-12 text-blue-500/20" />}
                    tipo={saldoLiquidoGeral >= 0 ? 'sucesso' : 'erro'}
                />
            </section>
