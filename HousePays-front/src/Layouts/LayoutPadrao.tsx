...
export const LayoutPadrao: React.FC<LayoutPadraoProps> = ({
    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col">
            {/* cabecalho */}
            <header className="bg-gradient-to-r from-blue-700 to-blue-900 text-white shadow-md py-6 px-8 shrink-0">
                <div className="max-w-7xl mx-auto flex flex-col sm:flex-row gap-4 justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-blue-200">Gerenciador de Gastos Residenciais Colaborativo</p>
                        </div>
                    </div>
                    <button
                        onClick={onSincronizar}
                        className="flex items-center gap-2 bg-amber-500 hover:bg-amber-600 px-4 py-2 rounded-lg text-sm transition-all duration-200 active:scale-95 cursor-pointer font-bold text-white shadow-xs"
                    >
